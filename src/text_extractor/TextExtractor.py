...
cloud_credentials = r'C:\Users\jordi\AppData\Roaming\gcloud\application_default_credentials.json'


def extract_text(img_paths, engine, rescale=False, binarize=False, clustering=False, autocorrect=False, text_panel=False):
    """
    ...
    :param text_panel: Bool determining if text panel pre-processing step should be applied.
